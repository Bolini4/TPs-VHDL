...
ARCHITECTURE structure OF TP1_adders IS
...
SIGNAL \b2v_inst1|hadder2|s~combout\ : std_logic;
SIGNAL \b2v_inst2|hadder2|s~combout\ : std_logic;
SIGNAL \b2v_inst3|hadder2|s~combout\ : std_logic;
SIGNAL \b2v_inst4|hadder1|s~combout\ : std_logic;
...
SIGNAL \b2v_inst4|hadder1|ALT_INV_s~combout\ : std_logic;
...
\b2v_inst4|hadder1|ALT_INV_s~combout\ <= NOT \b2v_inst4|hadder1|s~combout\;
...
-- Equation(s):
-- \b2v_inst1|cout~combout\ = ( \B[0]~input_o\ & ( \B[1]~input_o\ & ( ((\Cin~input_o\) # (\A[1]~input_o\)) # (\A[0]~input_o\) ) ) ) # ( !\B[0]~input_o\ & ( \B[1]~input_o\ & ( ((\A[0]~input_o\ & \Cin~input_o\)) # (\A[1]~input_o\) ) ) ) # ( \B[0]~input_o\ & ( 
...
-- Equation(s):
-- \b2v_inst3|cout~combout\ = ( \B[3]~input_o\ & ( \A[3]~input_o\ ) ) # ( !\B[3]~input_o\ & ( \A[3]~input_o\ & ( (!\B[2]~input_o\ & (\b2v_inst1|cout~combout\ & \A[2]~input_o\)) # (\B[2]~input_o\ & ((\A[2]~input_o\) # (\b2v_inst1|cout~combout\))) ) ) ) # ( 
-- \B[3]~input_o\ & ( !\A[3]~input_o\ & ( (!\B[2]~input_o\ & (\b2v_inst1|cout~combout\ & \A[2]~input_o\)) # (\B[2]~input_o\ & ((\A[2]~input_o\) # (\b2v_inst1|cout~combout\))) ) ) )
...
PORT MAP (
	...
	datab => \b2v_inst1|ALT_INV_cout~combout\,
...
-- Equation(s):
-- \b2v_inst5|cout~combout\ = ( \b2v_inst3|cout~combout\ & ( (!\B[5]~input_o\ & (\A[5]~input_o\ & ((\A[4]~input_o\) # (\B[4]~input_o\)))) # (\B[5]~input_o\ & (((\A[4]~input_o\) # (\A[5]~input_o\)) # (\B[4]~input_o\))) ) ) # ( !\b2v_inst3|cout~combout\ & ( 
...
PORT MAP (
	...
	dataf => \b2v_inst3|ALT_INV_cout~combout\,
	combout => \b2v_inst5|cout~combout\);

-- Location: LABCELL_X38_Y2_N54
\b2v_inst7|cout\ : cyclonev_lcell_comb
-- Equation(s):
-- \b2v_inst7|cout~combout\ = ( \b2v_inst5|cout~combout\ & ( (!\A[7]~input_o\ & (\B[7]~input_o\ & ((\A[6]~input_o\) # (\B[6]~input_o\)))) # (\A[7]~input_o\ & (((\B[7]~input_o\) # (\A[6]~input_o\)) # (\B[6]~input_o\))) ) ) # ( !\b2v_inst5|cout~combout\ & ( 
...
\b2v_inst1|hadder2|s\ : cyclonev_lcell_comb
-- Equation(s):
-- \b2v_inst1|hadder2|s~combout\ = ( \B[0]~input_o\ & ( \B[1]~input_o\ & ( !\A[1]~input_o\ $ (((\A[0]~input_o\) # (\Cin~input_o\))) ) ) ) # ( !\B[0]~input_o\ & ( \B[1]~input_o\ & ( !\A[1]~input_o\ $ (((\Cin~input_o\ & \A[0]~input_o\))) ) ) ) # ( 
...
PORT MAP (
	...
	datae => \ALT_INV_B[0]~input_o\,
	dataf => \ALT_INV_B[1]~input_o\,
	combout => \b2v_inst1|hadder2|s~combout\);

-- Location: LABCELL_X38_Y2_N27
\b2v_inst2|hadder2|s\ : cyclonev_lcell_comb
-- Equation(s):
-- \b2v_inst2|hadder2|s~combout\ = ( \A[2]~input_o\ & ( !\B[2]~input_o\ $ (\b2v_inst1|cout~combout\) ) ) # ( !\A[2]~input_o\ & ( !\B[2]~input_o\ $ (!\b2v_inst1|cout~combout\) ) )
...
PORT MAP (
	...
	combout => \b2v_inst2|hadder2|s~combout\);

-- Location: LABCELL_X38_Y2_N24
\b2v_inst3|hadder2|s\ : cyclonev_lcell_comb
-- Equation(s):
-- \b2v_inst3|hadder2|s~combout\ = ( \A[3]~input_o\ & ( !\B[3]~input_o\ $ (((!\B[2]~input_o\ & (\b2v_inst1|cout~combout\ & \A[2]~input_o\)) # (\B[2]~input_o\ & ((\A[2]~input_o\) # (\b2v_inst1|cout~combout\))))) ) ) # ( !\A[3]~input_o\ & ( !\B[3]~input_o\ $ 
-- (((!\B[2]~input_o\ & ((!\b2v_inst1|cout~combout\) # (!\A[2]~input_o\))) # (\B[2]~input_o\ & (!\b2v_inst1|cout~combout\ & !\A[2]~input_o\)))) ) )
...
\b2v_inst4|hadder1|s\ : cyclonev_lcell_comb
-- Equation(s):
-- \b2v_inst4|hadder1|s~combout\ = !\B[4]~input_o\ $ (!\A[4]~input_o\)
...
PORT MAP (
	...
	combout => \b2v_inst4|hadder1|s~combout\);

-- Location: LABCELL_X38_Y2_N36
\b2v_inst4|hadder2|s\ : cyclonev_lcell_comb
-- Equation(s):
-- \b2v_inst4|hadder2|s~combout\ = ( \B[3]~input_o\ & ( \A[3]~input_o\ & ( !\b2v_inst4|hadder1|s~combout\ ) ) ) # ( !\B[3]~input_o\ & ( \A[3]~input_o\ & ( !\b2v_inst4|hadder1|s~combout\ $ (((!\b2v_inst1|cout~combout\ & ((!\B[2]~input_o\) # 
-- (!\A[2]~input_o\))) # (\b2v_inst1|cout~combout\ & (!\B[2]~input_o\ & !\A[2]~input_o\)))) ) ) ) # ( \B[3]~input_o\ & ( !\A[3]~input_o\ & ( !\b2v_inst4|hadder1|s~combout\ $ (((!\b2v_inst1|cout~combout\ & ((!\B[2]~input_o\) # (!\A[2]~input_o\))) # 
-- (\b2v_inst1|cout~combout\ & (!\B[2]~input_o\ & !\A[2]~input_o\)))) ) ) ) # ( !\B[3]~input_o\ & ( !\A[3]~input_o\ & ( \b2v_inst4|hadder1|s~combout\ ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \b2v_inst4|hadder1|ALT_INV_s~combout\,
	datab => \b2v_inst1|ALT_INV_cout~combout\,
...
-- Equation(s):
-- \b2v_inst5|hadder2|s~combout\ = ( \b2v_inst3|cout~combout\ & ( !\B[5]~input_o\ $ (!\A[5]~input_o\ $ (((\A[4]~input_o\) # (\B[4]~input_o\)))) ) ) # ( !\b2v_inst3|cout~combout\ & ( !\B[5]~input_o\ $ (!\A[5]~input_o\ $ (((\B[4]~input_o\ & \A[4]~input_o\)))) 
-- ) )
...
-- Equation(s):
-- \b2v_inst6|hadder1|s~combout\ = ( \B[6]~input_o\ & ( !\A[6]~input_o\ ) ) # ( !\B[6]~input_o\ & ( \A[6]~input_o\ ) )
...
-- Equation(s):
-- \b2v_inst6|hadder2|s~combout\ = ( \B[5]~input_o\ & ( \B[4]~input_o\ & ( !\b2v_inst6|hadder1|s~combout\ $ (((!\A[5]~input_o\ & (!\A[4]~input_o\ & !\b2v_inst3|cout~combout\)))) ) ) ) # ( !\B[5]~input_o\ & ( \B[4]~input_o\ & ( !\b2v_inst6|hadder1|s~combout\ 
-- $ (((!\A[5]~input_o\) # ((!\A[4]~input_o\ & !\b2v_inst3|cout~combout\)))) ) ) ) # ( \B[5]~input_o\ & ( !\B[4]~input_o\ & ( !\b2v_inst6|hadder1|s~combout\ $ (((!\A[5]~input_o\ & ((!\A[4]~input_o\) # (!\b2v_inst3|cout~combout\))))) ) ) ) # ( !\B[5]~input_o\ 
-- & ( !\B[4]~input_o\ & ( !\b2v_inst6|hadder1|s~combout\ $ (((!\A[5]~input_o\) # ((!\A[4]~input_o\) # (!\b2v_inst3|cout~combout\)))) ) ) )
...
PORT MAP (
	...
	datab => \ALT_INV_A[4]~input_o\,
	datac => \b2v_inst3|ALT_INV_cout~combout\,
	datad => \b2v_inst6|hadder1|ALT_INV_s~combout\,
...
-- Equation(s):
-- \b2v_inst7|hadder2|s~combout\ = ( \b2v_inst5|cout~combout\ & ( !\A[7]~input_o\ $ (!\B[7]~input_o\ $ (((\A[6]~input_o\) # (\B[6]~input_o\)))) ) ) # ( !\b2v_inst5|cout~combout\ & ( !\A[7]~input_o\ $ (!\B[7]~input_o\ $ (((\B[6]~input_o\ & \A[6]~input_o\)))) 
-- ) )
