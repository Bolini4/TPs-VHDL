...
-- D[0]	=>  Location: PIN_AD12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- D[2]	=>  Location: PIN_U20,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \Y[0]~0_combout\ = ( \D[3]~input_o\ & ( \D[2]~input_o\ ) ) # ( \D[3]~input_o\ & ( !\D[2]~input_o\ ) ) # ( !\D[3]~input_o\ & ( !\D[2]~input_o\ & ( \D[1]~input_o\ ) ) )
...
-- Equation(s):
-- \Y[1]~1_combout\ = ( \D[3]~input_o\ & ( \D[2]~input_o\ ) ) # ( !\D[3]~input_o\ & ( \D[2]~input_o\ ) ) # ( \D[3]~input_o\ & ( !\D[2]~input_o\ ) )
